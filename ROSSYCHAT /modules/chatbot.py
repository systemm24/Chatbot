...
from ROSSYCHAT.modules.helpers import CHATBOT_ON, is_admins


@ROSSYCHAT.on_cmd("chatbot", group_only=True)
...
async def chatbot_text(client: Client, message: Message):
    ...
    if not message.reply_to_message:
        ROSSYdb = MongoClient(MONGO_URL)
        ROSSY = ROSSYdb["ROSSYDb"]["ROSSY"]
        is_ROSSY = ROSSY.find_one({"chat_id": message.chat.id})
        if not is_ROSSY:
