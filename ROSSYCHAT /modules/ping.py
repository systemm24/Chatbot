...
from ROSSYCHAT.modules.helpers import PNG_BTN
...
async def ping(_, message: Message):
    ...
    await loda.edit_text(
        text=f"нey вαву!!\n{ROSSYCHAT.name} ιѕ alιve 🥀 αnd worĸιng ғιne wιтн a pιng oғ\n➥ `{ms}` ms\n\n<b>|| мαdє ωιтн ❣️ ву [VM_COOL❣️](https://t.me/{OWNER_USERNAME}) ||</b>",
